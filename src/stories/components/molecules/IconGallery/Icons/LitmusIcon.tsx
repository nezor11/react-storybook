...
const LitmusIcon: React.FC<IconProps> = forwardRef<SVGSVGElement, IconProps>(
  ({ name, desc, width, height, ...props }, ref) => (
    ...
    >
      ...
      <path
        fill="#A09440"
        d="M93.597 87.948 48.946 27.277C30.192 42.024 15.664 61.898 7.466 84.785l71.289 22.937a53.225 53.225 0 0 1 14.842-19.774"
      />
      <path
        fill="#AFA148"
      ...
      <path
        fill="#4C5C59"
        d="M78.044 148.12 7.512 171.222c8.316 23.145 23.104 43.203 42.191 57.981l43.531-59.892a53.18 53.18 0 0 1-15.19-21.191"
      />
      <path
        fill="#48555D"
      ...
      <path
        fill="#D65841"
        d="m162.495 168.577 44.317 60.217c19.033-14.892 33.734-35.058 41.928-58.294l-71.649-23.052a53.147 53.147 0 0 1-14.596 21.129"
      />
      <path
        fill="#E6703E"
      ...
      <path
        fill="#F4A83A"
        d="m176.188 107.874 72.154-23.634c-8.332-22.937-23.032-42.818-41.967-57.501l-44.718 61.526a53.203 53.203 0 0 1 14.531 19.609"
      />{" "}
    </svg>
  )
);
