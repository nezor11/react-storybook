...
const TypeScriptIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ name = "TypeScript", desc, width, height, ...props }, ref) => (
    <svg
...
const MemoizedTypeScriptIcon = memo(TypeScriptIcon);

export default MemoizedTypeScriptIcon;
