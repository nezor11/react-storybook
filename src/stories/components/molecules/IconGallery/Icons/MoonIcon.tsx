...
const MoonIcon: React.FC<IconProps> = forwardRef<SVGSVGElement, IconProps>(
...
const MemoizedMoonIcon: React.FC<IconProps> = memo(MoonIcon);

export default MemoizedMoonIcon;
