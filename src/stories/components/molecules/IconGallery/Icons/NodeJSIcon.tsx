...
const NodeJSIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ name = "Node.js", desc, width, height, ...props }, ref) => (
    <svg
...
const MemoizedNodeJSIcon = memo(NodeJSIcon);

export default MemoizedNodeJSIcon;
