...
const SanityIcon: React.FC<IconProps> = forwardRef<SVGSVGElement, IconProps>(
  ({ name, desc, width, height, ...props }, ref) => (
    ...
    >
      ...
      <rect width="128" height="128" rx="8" fill="#f03e2f"></rect>
      <path
...
const MemoizedSanityIcon: React.FC<IconProps> = memo(SanityIcon);
